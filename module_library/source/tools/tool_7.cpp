...
// Tool stack (in order):
//  - MouseListener (attachments=1)

class Tool_tool_7 : public ITool {
public:
    const char* id_cstr() const noexcept override { return "tool_7"; }
    const char* name_cstr() const noexcept override { return "MouseListener"; }
