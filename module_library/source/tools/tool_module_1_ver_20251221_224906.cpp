// Generated from module module_1
#include "tool_api.h"
...
class Tool_tool_module_1 : public ITool {
public:
    std::string id() const override { return "tool_module_1"; }
    std::string name() const override { return "tool_module_1"; }
