...
inline constexpr OpDesc kOps[] = {
    ...
    {"matmul", 56, OpClass::Opaque, -1, "", 2, false, false, true, "", "Call", "matmul_double"},
    {"sum", 57, OpClass::Opaque, -1, "", 1, false, false, false, "", "Call", "sum_double"},
    {"mean", 58, OpClass::Opaque, -1, "", 1, false, false, false, "", "Call", "mean_dim"},
    {"topk", 59, OpClass::Opaque, -1, "", 1, false, false, false, "", "Call", "topk_double"},
    {"log_softmax", 60, OpClass::Opaque, -1, "", 1, false, false, false, "", "Call", "log_softmax_dim"},
    {"pad", 61, OpClass::Opaque, -1, "", 1, false, false, false, "", "Call", "pad_double_nd"},
    {"stack", 62, OpClass::Opaque, -1, "", 2, false, false, false, "", "Call", "stack_double"},
    {"cat", 63, OpClass::Opaque, -1, "", 2, false, false, false, "", "Call", "cat_double"},
    {"gather", 64, OpClass::Opaque, -1, "", 2, false, false, false, "", "Load", "gather_pairs_2d"},
    {"arange", 65, OpClass::Opaque, -1, "", 0, false, false, false, "", "", "create_arange"},
};
