...
set "GATE_GESTATION_LOSS_TARGET=0.28"
...
set "GATE_BERKELEY_LOSS_TARGET=0.28"
...
if not "%SEMANTIC_VOCAB_BOOTSTRAP_ORIGIN_LABEL%"=="" set "SEMANTIC_VOCAB_ARG=%SEMANTIC_VOCAB_ARG% --semantic-vocab-bootstrap-origin-label ""%SEMANTIC_VOCAB_BOOTSTRAP_ORIGIN_LABEL%"""
